...
begin
  insert into public.despesas
    (tipo, data, fornecedor, nif, total, iva, categoria, pago_por, ficheiro, confirmada)
  values (
...
grant execute on function public.registar_fatura(text,text,text,text,text,text,text,text,text)
